...
CREATE TABLE CAST_NAME_ACTOR (
								IDT_CAST_NAME_ACTOR INTEGER NOT NULL,
								IDT_ACTOR INTEGER NOT NULL,
								CONSTRAINT CAST_NAME_ACTOR_PK PRIMARY KEY (IDT_CAST_NAME_ACTOR),
								CONSTRAINT CAST_NAME_ACTOR_ACTOR_FK FOREIGN KEY(IDT_ACTOR) REFERENCES ACTOR(IDT_ACTOR)
);

CREATE TABLE NAME_CAST (
                        	IDT_NAME_CAST INTEGER NOT NULL,
        					IDT_CAST_NAME_ACTOR NOT NULL,
                            CONSTRAINT NAME_CAST_PK PRIMARY KEY (IDT_NAME_CAST),
                            CONSTRAINT NAME_CAST_CAST_NAME_ACTOR_FK FOREIGN KEY(IDT_CAST_NAME_ACTOR) REFERENCES CAST_NAME_ACTOR(IDT_CAST_NAME_ACTOR)
);
...
CREATE TABLE NAME_DIRECTION (
								IDT_NAME_DIRECTION INTEGER NOT NULL,
								IDT_DIRECTOR INTEGER NOT NULL,
								CONSTRAINT NAME_DIRECTION_PK PRIMARY KEY (IDT_NAME_DIRECTION),
								CONSTRAINT NAME_DIRECTION_DIRECTOR_FK FOREIGN KEY(IDT_DIRECTOR) REFERENCES DIRECTOR(IDT_DIRECTOR)
...
CREATE TABLE DIRECTION (
                            ...
                            IDT_NAME_DIRECTION INTEGER NOT NULL,
                            CONSTRAINT DIRECTION_PK PRIMARY KEY(IDT_DIRECTION),
                            CONSTRAINT DIRECTION_NAME_DIRECTION_FK FOREIGN KEY(IDT_NAME_DIRECTION) REFERENCES NAME_DIRECTION(IDT_NAME_DIRECTION)
);
...
CREATE TABLE TITLE_GENRE (
	   						IDT_TITLE_GENRE INTEGER NOT NULL,
       						IDT_GENRE INTEGER NOT NULL,
       						CONSTRAINT TITLE_GENRE_PK PRIMARY KEY(IDT_TITLE_GENRE),
...
CREATE TABLE TITLE (
                        ...
                        CONSTRAINT TITLE_TITLE_GENRE_FK FOREIGN KEY(IDT_TITLE_GENRE) REFERENCES TITLE_GENRE(IDT_TITLE_GENRE),
