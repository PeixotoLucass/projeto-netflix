/* EXCLUINDO AS TABELAS PARA CRIAÇÃO DE NOVAS */

ALTER TABLE PERSON DROP CONSTRAINT PERSON_USER_FK;

DROP TABLE USER_TYPE;

ALTER TABLE HISTORY DROP CONSTRAINT HISTORY_PERSON_FK;

ALTER TABLE HISTORY DROP CONSTRAINT HISTORY_TITLE_FK;

DROP TABLE PERSON;

ALTER TABLE CAST_ACTOR  DROP CONSTRAINT CAST_ACTOR_ACTOR_FK;

ALTER TABLE CAST_ACTOR  DROP CONSTRAINT CAST_ACTOR_NAME_CAST_FK;

DROP TABLE ACTOR;

DROP TABLE CAST_ACTOR ;

ALTER TABLE TITLE DROP CONSTRAINT TITLE_NAME_CAST_FK;

DROP TABLE NAME_CAST;

ALTER TABLE DIRECTION DROP CONSTRAINT DIRECTION_DIRECTOR_FK;

ALTER TABLE DIRECTION DROP CONSTRAINT DIRECTION_TITLE_FK;

DROP TABLE DIRECTOR;

DROP TABLE DIRECTION;

ALTER TABLE TITLE_GENRE DROP CONSTRAINT TITLE_GENRE_GENRE_FK;

ALTER TABLE TITLE_GENRE DROP CONSTRAINT TITLE_GENRE_TITLE_FK;
