...
public class TitleDirectorDTO {
  ...
  public TitleDirectorDTO(Title title) {
    ...
    List<Director> listDirector = title.getDirectors();
    List<DirectorTitleDTO> listDirectorDTO = listDirector.stream()
        .map(director -> new DirectorTitleDTO(director))
    ...
    this.directorList = listDirectorDTO;
  }
